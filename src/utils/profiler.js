...
//
// Lives in src/utils because the game loop depends on it. It previously sat in
// js/editor/debug/, which .gitignore excludes, so a clean checkout of the repo
// could not resolve the import from js/game.js and the game failed to load.
// ═══════════════════════════════════════════════════════════════════
