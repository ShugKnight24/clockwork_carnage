// Frozen copy of src/world/world.js from before column storage (feat/v0.8.0,
// 16397dd): the flat 128 x 128 x 64 array. It is the reference the column
// world is checked against, so it must not be edited to match new behaviour.
