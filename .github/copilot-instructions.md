...
```
game.js:             ~10,936 lines (primary class — extraction ongoing)
data.js:              ~6,406 lines (all game data — maps, enemies, weapons, ARIA_COMMS)
renderer.js:          ~4,795 lines
cutscene.js:          ~3,214 lines (extracted)
builder.js:           ~1,668 lines (extracted)
touch.js:             ~1,360 lines
meltdown.js:            ~995 lines (Meltdown: Reactor Run)
audio.js:               ~518 lines (thin — major opportunity)
main.js:                ~453 lines
gamepad.js:             ~375 lines
settings-registry.js:   ~348 lines (extracted, Node-testable)
entities.js:            ~168 lines
layout.js:              ~126 lines (extracted, pure functions)
state-manager.js:       ~119 lines (extracted)
analytics.js:           ~113 lines
components/:          ~1,050 lines (title screen web components)
net/:                   ~590 lines (WebSocket POC — not integrated)
editor/:              ~1,200 lines (Forge editor scaffold — aspirational)
Total:             ~34,434 lines
```
